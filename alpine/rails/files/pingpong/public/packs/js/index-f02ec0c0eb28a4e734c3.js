...
/* WEBPACK VAR INJECTION */(function($, _) {$(function () {
  ...
  App.Views.Guilds = Backbone.View.extend({
    initialize: function initialize() {
      ...
      this.collection.on('change', this.addOne2, this);
      this.render();
    },
    render: function render() {
    ...
    addOne2: function addOne2(guild) {
      console.log("change");
      var guildView = new App.Views.Guild({
        model: guild
      });
  ...
  App.Views.NewGuild = Backbone.View.extend({
    ...
    submit: function submit(e) {
      ...
      window.blabla = new_guild;
      $.when(promise).done(_.bind(function (data) {
        alert('success'); // this.collection.fetch()

        this.collection.add(blabla);
      }, this));
...
/******/ });
//# sourceMappingURL=index-f02ec0c0eb28a4e734c3.js.map