...
/* WEBPACK VAR INJECTION */(function($, _) {$(function () {
  ...
  App.Models.Page = Backbone.Model.extend({
    ...
    get_access: function get_access() {
      console.log("11111111111111"); // fetch('http://localhost:3000/get_is_logged_in')
      // .then(resp => resp.json())
      // .then(auth => {
      // 	this.access = auth;
      // })
  ...
  App.Views.TestPage = Backbone.View.extend({
    ...
    auth: false,
    initialize: function initialize() {
      console.log("22222222222222"); // fetch('http://localhost:3000/get_is_logged_in')
      // .then(resp => resp.json())
      // .then(auth => {
      // 	if (auth == false) {
  ...
  App.Views.HomePage = Backbone.View.extend({
    ...
    auth: false,
    initialize: function initialize() {
      console.log("33333333333333333"); // fetch('http://localhost:3000/get_is_logged_in')
      // .then(resp => resp.json())
      // .then(auth => {
      // 	if (auth == false) {
      // 		this.$el.html(this.form_template);
  ...
  App.Router = Backbone.Router.extend({
    routes: {
      ...
      'tournament': 'http://localhost:3000/#tournament_page',
      'test': 'http://localhost:3000/#test_page',
      'logout': 'http://localhost:3000/#logout_page',
      'login': 'http://localhost:3000/#home_page'
    },
...
/******/ });
//# sourceMappingURL=app-54ee82bdc5234deefade.js.map