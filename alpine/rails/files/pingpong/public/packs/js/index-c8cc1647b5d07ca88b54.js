...
/* WEBPACK VAR INJECTION */(function($, _) {$(function () {
  ...
  App.Views.NewGuild = Backbone.View.extend({
    ...
    submit: function submit(e) {
      ...
      new_guild.save(); // new_guild.changedAttributes()

      this.collection.fetch(); // alert(new_guild.name + new_guild.owner_id)
      // new_guild.sync()
...
/******/ });
//# sourceMappingURL=index-c8cc1647b5d07ca88b54.js.map