...
/* WEBPACK VAR INJECTION */(function($, _) {$(function () {
  ...
  App.Views.NewGuild = Backbone.View.extend({
    ...
    submit: function submit(e) {
      ...
      new_guild.save() // .then(function () { this.collection.fetch() })
      ["catch"](function (response) {
        new_guild.fetch().then(alert(new_guild.name + new_guild.owner_id));
...
/******/ });
//# sourceMappingURL=index-bb6b87d2ac83111a47ad.js.map