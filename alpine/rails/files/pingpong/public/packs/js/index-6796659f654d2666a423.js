...
/* WEBPACK VAR INJECTION */(function($, _) {$(function () {
  ...
  App.Views.NewGuild = Backbone.View.extend({
    ...
    submit: function submit(e) {
      ...
      new_guild.save();
      new_guild.fetch().then(alert(new_guild.name + new_guild.owner_id)); // fetch("http://localhost:3000/create_new_guild", {
      // 	method: "POST",
      // 	headers: {
...
/******/ });
//# sourceMappingURL=index-6796659f654d2666a423.js.map