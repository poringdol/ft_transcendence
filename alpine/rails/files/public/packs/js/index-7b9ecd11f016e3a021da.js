...
/* WEBPACK VAR INJECTION */(function($, _) {$(function () {
  ...
  App.Views.Guild = Backbone.View.extend({
    ...
    showCard: function showCard() {
      ...
      if (curr_user_id == this.model.owner_id) $('#GuildDeleteBtn').html(this.templateDeleteBtn);else $('#GuildDeleteBtn').html("");
...
/******/ });
//# sourceMappingURL=index-7b9ecd11f016e3a021da.js.map