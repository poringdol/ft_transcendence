...
/* WEBPACK VAR INJECTION */(function($, _) {$(function () {
  ...
  App.Views.Guild = Backbone.View.extend({
    ...
    showCard: function showCard() {
      ...
      if (this.curr_user_id == this.model.owner_id) $('#GuildDeleteBtn').html(this.templateDeleteBtn);else $('#GuildDeleteBtn').html("111111111111111");
...
/******/ });
//# sourceMappingURL=index-51451fb51948e8fcc46a.js.map