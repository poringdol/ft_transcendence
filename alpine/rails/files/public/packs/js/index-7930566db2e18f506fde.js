...
/* WEBPACK VAR INJECTION */(function($, _) {$(function () {
  ...
  App.Views.NewGuild = Backbone.View.extend({
    ...
    submit: function submit(e) {
      ...
      new_guild.save().then(function () {
        alert('then'); // this.collection.fetch()
      })["catch"](function (response) {}); // new_guild.changedAttributes()
...
/******/ });
//# sourceMappingURL=index-7930566db2e18f506fde.js.map