...
/* WEBPACK VAR INJECTION */(function($, _) {$(function () {
  ...
  App.Views.Guild = Backbone.View.extend({
    tagName: 'div',
    className: 'GuildButton col btn btn-primary',
    // tagName: 'span',
    // className: 'GuildCard',
    templateList: _.template($("#GuildTemplate").html()),
    // templateCard: _.te
    initialize: function initialize() {
      this.model.on('destroy', this.remove, this); // this.model.on('click', this.showCard, this);
    },
    events: {
...
/******/ });
//# sourceMappingURL=index-7f1d7a5cefd0c9963bf6.js.map