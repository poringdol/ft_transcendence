...
/* WEBPACK VAR INJECTION */(function($, _) {$(function () {
  ...
  App.Models.Page = Backbone.Model.extend({
    ...
    get_access: function get_access() {
      console.log("GET ACCESS"); // fetch('http://localhost:3000/get_is_logged_in')
      // .then(resp => resp.json())
      // .then(auth => {
      // 	this.access = auth;
      // })
  ...
  App.Views.TestPage = Backbone.View.extend({
    ...
    auth: false,
    initialize: function initialize() {
      console.log("VIEW TEST"); // fetch('http://localhost:3000/get_is_logged_in')
      // .then(resp => resp.json())
      // .then(auth => {
      // 	if (auth == false) {
  ...
  App.Views.HomePage = Backbone.View.extend({
    ...
    auth: false,
    initialize: function initialize() {
      console.log("VIEW HOME"); // fetch('http://localhost:3000/get_is_logged_in')
      // .then(resp => resp.json())
      // .then(auth => {
      // 	if (auth == false) {
      // 		this.$el.html(this.form_template);
  ...
  App.Router = Backbone.Router.extend({
    routes: {
      'http://localhost:3000/#': 'home_page',
      'http://localhost:3000/#tournament': 'tournament_page',
      'http://localhost:3000/#test': 'test_page',
      'http://localhost:3000/#logout': 'logout_page',
      'http://localhost:3000/#login': 'home_page'
    },
...
/* WEBPACK VAR INJECTION */}.call(this, __webpack_require__(/*! jquery/src/jquery */ "./node_modules/jquery/src/jquery.js"), __webpack_require__(/*! underscore/underscore */ "./node_modules/underscore/underscore.js")))
...
(function (global, factory) {
  ...
  var hasObjectTag = tagTester('Object'); // In IE 10 - Edge 13, `DataView` has string tag `'[object Object]'`.
  ...
  var isWeakSet = tagTester('WeakSet'); // Retrieve the values of an object's properties.
...
/******/ });
//# sourceMappingURL=app-5e9b3cfbebba97b77241.js.map