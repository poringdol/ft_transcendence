...
/* WEBPACK VAR INJECTION */(function($, _) {$(function () {
  ...
  App.Views.GuildCard = Backbone.View.extend({
    ...
    initialize: function initialize(data) {
      this.model = data.model;
      this.user_id = data.user_id; // this.model.on('destroy', this.remove, this);
    ...
    showCard: function showCard() {
      ...
      if (this.user_id == this.model.owner_id) {
        ...
        alert("SUCCESS");
      } else $('#GuildDeleteBtn').html("111111111111111");
...
/******/ });
//# sourceMappingURL=index-2e153c02cce9c8873e61.js.map