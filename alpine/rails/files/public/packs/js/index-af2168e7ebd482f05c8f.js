  ...
  App.Views.GuildCardBtn = Backbone.View.extend({
    ...
    leaveGuild: function leaveGuild() {
      ...
      var promise = fetch("http://localhost:3000/guilds/exit", {
        ...
        curr_user.guild_id = 0;
        if (response == 0) _this3.model.destroy();else _this3.model.owner_nickname = response.nickname; // this.model.owner_nickname = "AAA"
        ...
        $('#GuildContent').html("");
        $('#GuildCardOwner').html("Owner: " + _this3.model.owner_nickname);
      }, this));
      return this;
    }
  }); // -----------------------------------------
...
/******/ });
//# sourceMappingURL=index-af2168e7ebd482f05c8f.js.map