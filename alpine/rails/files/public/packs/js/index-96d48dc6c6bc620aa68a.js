...
/* WEBPACK VAR INJECTION */(function($, _) {$(function () {
  ...
  App.Views.GuildCardBtn = Backbone.View.extend({
    ...
    render: function render() {
      if (curr_user.id == this.model.owner_id) this.$el.html(this.templateDeleteBtn);else if (curr_user.guild_id == 0) this.$el.html(this.templateJoinBtn);else this.$el.html("");
      $('#GuildCardBtn').html(this.el);
    },
    events: {
      'click #delete_guild': 'delete_guild',
      'click #join_guild': 'join_guild'
    },
  ...
  App.Views.NewGuild = Backbone.View.extend({
    ...
    submit: function submit(e) {
      ...
      $.when(promise).done(_.bind(function (data) {
        ...
        $('#GuildCard').html("");
        $('#GuildContent').html(""); // curr_user.guild_id = new_guild.id
      }, this));
...
/******/ });
//# sourceMappingURL=index-96d48dc6c6bc620aa68a.js.map