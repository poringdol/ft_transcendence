...
/* WEBPACK VAR INJECTION */(function($, _) {$(function () {
  ...
  App.Views.Guild = Backbone.View.extend({
    ...
    showCard: function showCard() {
      ...
      if (this.curr_user_id == this.model.owner_id) {
        $('#GuildDeleteBtn').html(this.templateDeleteBtn);
        alert(this.curr_user_id + "-" + this.model.owner_id);
      } else {
        $('#GuildDeleteBtn').html("111111111111111");
        alert("fail" + this.curr_user_id + "-" + this.model.owner_id);
      }
  ...
  App.Views.Guilds = Backbone.View.extend({
    ...
    render: function render() {
      this.collection.each(this.addOne, this, this.curr_user_id);
      alert("render " + this.curr_user_id);
      $('#GuildList').append(this.el);
      return this;
    },
    addOne: function addOne(guild, curr_user_id) {
  ...
  fetch("http://localhost:3000/get_curr_user").then(function (res) {
    ...
    console.log("render " + curr_user_id);
  });
}());
...
/******/ });
//# sourceMappingURL=index-ef98a7235bbdde5f9775.js.map