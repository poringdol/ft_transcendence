...
/* WEBPACK VAR INJECTION */(function($, _) {$(function () {
  ...
  App.Collections.GuildUsers = Backbone.Collection.extend({
    ...
    initialize: function initialize(data) {
      this.url += '/' + data.guild; // var promise = this.fetch("http://localhost:3000/get_guild_users", {
      // 	method: "POST",
      // 	headers: {
...
/******/ });
//# sourceMappingURL=index-1781524c1f806682e899.js.map