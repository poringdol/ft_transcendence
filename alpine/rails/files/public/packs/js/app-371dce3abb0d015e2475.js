...
/* WEBPACK VAR INJECTION */(function($, _) {$(function () {
  ...
  App.Models.Page = Backbone.Model.extend({
    ...
    get_access: function get_access() {
      this.access = auth; // fetch('http://localhost:3000/get_is_logged_in')
      // .then(resp => resp.json())
      // .then(auth => {
      // 	this.access = auth;
      // })
  ...
  App.Views.TestPage = Backbone.View.extend({
    ...
    initialize: function initialize() {
      ...
      fetch('http://localhost:3000/get_is_logged_in').then(function (resp) {
        ...
        if (auth == false) {
          _this.$el.html(_this.form_template);

          _this.render_form();
        } else {
          _this.$el.html(_this.page_template);
...
/******/ });
//# sourceMappingURL=app-371dce3abb0d015e2475.js.map