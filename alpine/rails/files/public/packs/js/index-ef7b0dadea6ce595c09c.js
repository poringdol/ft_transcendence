...
/* WEBPACK VAR INJECTION */(function($, _) {$(function () {
  ...
  App.Views.Guild = Backbone.View.extend({
    ...
    showCard: function showCard() {
      ...
      if (this.curr_user_id == this.model.owner_id) $('#GuildDeleteBtn').html(this.templateDeleteBtn);else $('#GuildDeleteBtn').html("");
...
/******/ });
//# sourceMappingURL=index-ef7b0dadea6ce595c09c.js.map