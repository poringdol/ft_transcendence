...
/* WEBPACK VAR INJECTION */(function($, _) {$(function () {
  ...
  App.Views.GuildList = Backbone.View.extend({
    ...
    render: function render() {
      ...
      if (curr_user.guild_id == this.model.id) this.$el.className("users_guild"); // this.$el.css({ "background-color": "#82a4d730" })
    ...
    showCard: function showCard() {
      if (curr_user.guild_id == this.model.id) this.$el.css({
        "background-color": "#5c7b5b"
      });
      $('#GuildContent').html("");
  ...
  App.Views.GuildCardBtn = Backbone.View.extend({
    ...
    leaveGuild: function leaveGuild() {
      ...
      var promise = fetch("http://localhost:3000/guilds/exit", {
        ...
        curr_user.guild_id = 0;
        if (response == 0) _this3.model.destroy();else _this3.model.owner_id = response.id;

        _this3.render(); // this.model.save();
        // debugger
...
/******/ });
//# sourceMappingURL=index-15f4fb9cee71625b1a6a.js.map