  ...
  App.Views.GuildCardBtn = Backbone.View.extend({
    ...
    leaveGuild: function leaveGuild() {
      ...
      var promise = fetch("http://localhost:3000/guilds/exit", {
        ...
        curr_user.guild_id = 0;
        if (response == 0) _this3.model.destroy();else _this3.model.owner_nickname = response.id; // this.model.owner_nickname = "AAA"
        // this.render();
...
/******/ });
//# sourceMappingURL=index-da1dce3dbb2826db8018.js.map