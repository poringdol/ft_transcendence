  ...
  App.Views.NewGuild = Backbone.View.extend({
    ...
    submit: function submit(e) {
      ...
      var guild = {
        ...
        anagram: 'aloha',
        score: 0,
        owner_id: 2 // name: $(e.currentTarget).find('input[id=guildFormName]').val(),
        // anagram: $(e.currentTarget).find('input[id=guildFormAnagram]').val()

      };
      new_guild = new App.Models.Guild(guild);
      new_guild.save(); // fetch("http://localhost:3000/create_new_guild", {
      // 	method: "POST",
      // 	headers: {
...
/******/ });
//# sourceMappingURL=index-246d7892b26acd55d0dc.js.map