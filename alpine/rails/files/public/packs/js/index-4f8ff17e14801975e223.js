...
/* WEBPACK VAR INJECTION */(function($, _) {$(function () {
  ...
  App.Collections.GuildUsers = Backbone.Collection.extend({
    ...
    initialize: function initialize(data) {
      var promise = fetch("http://localhost:3000/get_guild_users", {
        method: "POST",
        headers: {
  ...
  App.Views.GuildUsers = Backbone.View.extend({
    ...
    addOne: function addOne(user) {
      ...
      console.log(user.nickname); // var userView = new App.Views.GuildUser({ model: user});
...
/******/ });
//# sourceMappingURL=index-4f8ff17e14801975e223.js.map