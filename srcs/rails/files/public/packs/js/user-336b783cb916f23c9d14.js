...
/******/ 	return __webpack_require__(__webpack_require__.s = "./app/javascript/packs/user.js");
/******/ })
/************************************************************************/
/******/ ({
  ...
  var OnlineUsersCollection = Backbone.Collection.extend({
    ...
    online: function online() {
      ...
      this.each(function (friend) {
        $("#ProfileOnlineStatus".concat(_this17.current_user_id)).css("color", "#37d00a");
        $("#ProfileOnlineStatus".concat(_this17.current_user_id)).html("online");
        $("#FriendOnlineStatus".concat(friend.get("id"))).css("background", "#37d00a");

        if (friend.get("id") == _this17.profile_id) {
          $("#ProfileOnlineStatus".concat(_this17.profile_id)).css("color", "#37d00a");
...
/******/ });
//# sourceMappingURL=user-336b783cb916f23c9d14.js.map