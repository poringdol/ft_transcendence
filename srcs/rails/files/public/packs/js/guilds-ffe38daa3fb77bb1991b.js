...
/******/ 	return __webpack_require__(__webpack_require__.s = "./app/javascript/packs/guilds.js");
/******/ })
/************************************************************************/
/******/ ({

/***/ "./app/javascript/packs/guilds.js":
/*!****************************************!*\
  !*** ./app/javascript/packs/guilds.js ***!
  \****************************************/
...
$(function () {
  ...
  App.Views.GuildCardBtn = Backbone.View.extend({
    ...
    render: function render() {
      ...
      else if (curr_user.attributes.guild_id == this.model.id) this.$el.html(this.templateLeaveBtn);else if (curr_user.attributes.guild_id != this.model.id && (curr_user.attributes.is_officer || curr_user.attributes.guild.owner_id == curr_user.attributes.id)) this.$el.html(this.templateWarBtn);else this.$el.html("");
...
/******/ });
//# sourceMappingURL=guilds-ffe38daa3fb77bb1991b.js.map