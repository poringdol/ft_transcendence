...
/******/ 	return __webpack_require__(__webpack_require__.s = "./app/javascript/packs/wars.js");
/******/ })
/************************************************************************/
/******/ ({

/***/ "./app/javascript/packs/wars.js":
/*!**************************************!*\
  !*** ./app/javascript/packs/wars.js ***!
  \**************************************/
...
/* WEBPACK VAR INJECTION */(function($, _) {var _require = __webpack_require__(/*! underscore */ "./node_modules/underscore/modules/index-all.js"),
...
$(function () {
  ...
  App.Views.War = Backbone.View.extend({
    ...
    render: function render() {
      ...
      if (this.model.get('is_accepted') == false && this.curr_user.get("guild_id") == this.model.get("guild2").id && (this.curr_user.get("is_officer") || this.curr_user.get("guild").owner_id == this.curr_user.get("id"))) {
    ...
    acceptWar: function acceptWar() {
      ...
      fetch("/wars/accept/" + this.model.get("id")).then(function (res) {
        ...
        if (res.error) alert(res.error);else {
          ...
          _this2.model.attributes.is_accepted = true;
  ...
  */
  ...
  App.Views.FormWar = Backbone.View.extend({
    ...
    submit: function submit(e) {
      ...
      if (war.max_unanswered == '') war.max_unanswered = 10;
      fetch("/wars", {
        method: "POST",
        headers: {
...
/******/ });
//# sourceMappingURL=wars-0f73902d71f519fe8ea7.js.map