...
/* WEBPACK VAR INJECTION */(function($, _) {$(function () {
  ...
  App.Models.Page = Backbone.Model.extend({
    ...
    get_access: function get_access() {
      console.log("GET ACCESS"); // fetch("/get_is_logged_in")
      // .then(resp => resp.json())
      // .then(auth => {
      // 	this.access = auth;
      // })
  ...
  App.Views.LogIn = Backbone.View.extend({
    ...
    login: function login() {
      fetch("/login"); // user_marvin_omniauth_authorize_path
    }
  });
  App.Views.TestPage = Backbone.View.extend({
    ...
    auth: false,
    initialize: function initialize() {
      console.log("VIEW TEST"); // fetch("/get_is_logged_in")
      // .then(resp => resp.json())
      // .then(auth => {
      // 	if (auth == false) {
  ...
  App.Views.HomePage = Backbone.View.extend({
    ...
    auth: false,
    initialize: function initialize() {
      console.log("VIEW HOME"); // fetch("/get_is_logged_in")
      // .then(resp => resp.json())
      // .then(auth => {
      // 	if (auth == false) {
      // 		this.$el.html(this.form_template);
...
/******/ });
//# sourceMappingURL=app-d9bdd9132c476c3430b5.js.map